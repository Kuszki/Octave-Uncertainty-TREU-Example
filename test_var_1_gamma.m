...
printf('\\textbf{Case 3)} $\\Delta t_{s} \\sim G(\\num{%0.2f}, \\qty{%0.1e}{s})$, $\\Delta t_{i} = \\qty{0}{s}$, $\\delta = \\qty{%0.2f}{\\percent}$ \\vskip6pt \\includegraphics{Pictures/hist_1_gamma}\n', k, theta, v_diff)

print("hist_1_gamma.svg");
